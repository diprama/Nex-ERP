            ...
            <div class="col-xs-9">
              <form role="form" action="?page=Validasi" method="POST" name="form1" target="_self" id="form1">
                ...
                <div style="padding-top: 60px" class="col-sm-1">
                  <button type="submit" class="btn btn-primary btn-s" name="btnHelpdesk"><i class="fa fa-filter fa-fw"></i> Filter</button>
              </form>
            </div>
          </div>
          ...
          <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              ?>
                ...
                <tr>
                  <td><?php echo $myData1['id'] ?></td>
                  <td><?php echo '[' . $namahari . ' ' . $day . ']' . ' [' . $d .  $h . $i . '] ' . $by; ?></td>
                </tr>
                <tr>
                  <td><?php echo $myData1['status'] ?></td>
                  <td><?php echo  $name; ?></td>
                </tr>
                <tr>
                  <td><?php echo $myData1['created'] ?></td>
                  <td><?php echo 'Category : ' .  $myData1['kategori_id']; ?></td>
                </tr>
                <tr>
                  <td><?php echo $myData1['status'] . ' Logs' ?></td>
                  <td><?php echo 'Description : ' . $myData1['deskripsi'] ?></td>
                </tr>
                <tr>
                  <td></td>
                  <td><?php echo 'Solution : ' . $myData1['solusi'] ?></td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
