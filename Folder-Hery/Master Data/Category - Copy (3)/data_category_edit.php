...
<div class="right_col" role="main">
  ...
  $ID = $_GET['id'];
  $query = "SELECT  * FROM helpdesk_kategori WHERE kd_kategori='" . $ID . "'";
  ...
  if (isset($_POST['btnSubmit'])) {
    ...
    if (count($pesanError) >= 1) {
      ...
      $mySql = "UPDATE helpdesk_kategori SET kd_kategori='$txtid', kategori='$txtname', updated_by='$ses_nama', updated_date= now()  WHERE kd_kategori='" . $ID . "'";
  ...
  ?>
      ...
      <?php
        echo "<meta http-equiv='refresh' content='0; url=?page=Data-Ticket-Category'>";
      } else {
      ?>
        <script type="text/javascript">
          alert("GAGAL");
          ...
          <div class="x_content ">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                ...
                <input class="form-control" placeholder="" value="<?php echo $kd_kategori; ?>" name="id" type="text" />
              </div>
            </div>
